...
package org.openengsb.connector.github;
...
public class GithubServiceManager extends AbstractServiceManager<IssueDomain, GithubService> {

    public GithubServiceManager(GithubServiceInstanceFactory githubServiceFactory) {
        super(githubServiceFactory);
    }
